...
class MyRWRPlus(tf.keras.layers.Layer):
    def __init__(self, args, metadata):
        super(MyRWRPlus, self).__init__()
        self.P = args.P
        self.Q = args.Q
    ...
    def build(self, input_shape):
        ...
        self.trans_dense = layers.Dense(self.num_kernels, use_bias=False)
    ...
    def call(self, X, TE):
        ...
        for k in range(self.k_step):
            ...
            X_move = tf.reshape(Xn, (-1, self.num_kernels, self.height+2, self.width+2, 1))
