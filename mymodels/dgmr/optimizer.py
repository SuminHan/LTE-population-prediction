...
class Optimizer(tf.Module):
  ...
  def __init__(self,
    ...
    self.disc_opt = tf.keras.optimizers.Adam(learning_rate=self.disc_lr, beta1=self.disc_beta1, beta2=self.disc_beta2)
    self.gen_opt = tf.keras.optimizers.Adam(learning_rate=self.gen_lr, beta1=self.gen_beta1, beta2=self.gen_beta2)
